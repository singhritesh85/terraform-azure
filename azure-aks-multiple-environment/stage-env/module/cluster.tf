...
# Network Profile
  network_profile {
    ...
    service_cidr        = "10.32.0.0/16"  ### Kubernetes service address range
    dns_service_ip      = "10.32.0.10"    ### Kubernetes DNS service IP address
  }
